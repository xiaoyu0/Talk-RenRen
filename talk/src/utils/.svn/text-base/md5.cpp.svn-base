...
void CMD5::md5_process( struct md5_context *ctx, uint8_t data[64] )
{
...
void CMD5::md5_update( struct md5_context *ctx, uint8_t *input, size_t length )
{
	uint32_t left, fill;
...
void CMD5::md5_finish( struct md5_context *ctx, uint8_t digest[16] )
{
	uint32_t last, padn;
	uint8_t msglen[8];
