...
* @date 2011-07-06
*/
#ifndef TALK_HTTP_SERVER_BoshSession_H_
#define TALK_HTTP_SERVER_BoshSession_H_
...
class BoshSession : public mtalk::talk::Session
{
public :
	BoshSession(std::string sessionId);
	
	~BoshSession();

	/**
	* @brief	该BoshSession的新链接到来时检查rid是否正确。
	* 			如果正确则更新BoshSession中保存的connection
	...
	*/
	...
	/**
	* @brief	往该BoshSession的接入设备推送消息，主要推送接口。
	...
	*/
	...
	void setInactivityTimeout(time_t time){  inactivityTimeout_ = time; }
...
#endif //TALK_HTTP_SERVER_BoshSession_H_
