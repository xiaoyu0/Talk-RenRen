...
bool TagParser::feed(const socket::SocketSessionPtr& SSPtr, const std::string& data) {
...
void TagParser::addTag(const socket::SocketSessionPtr& SSPtr) {
	if (_root.empty()) {
...
bool TagParser::closeTag(const socket::SocketSessionPtr& SSPtr) {
...
void TagParser::streamEvent(const socket::SocketSessionPtr& SSPtr, xml_document_ptr& tag) {
