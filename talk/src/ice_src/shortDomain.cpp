...
// Ice version 3.3.1
// Generated from file `shortDomain.ice'

#include <shortDomain.h>
...
{
    ::std::pair< ::std::string*, ::std::string*> r = ::std::equal_range(__com__xiaonei__wap__xuanyuan__service__ShortDomainService_all, __com__xiaonei__wap__xuanyuan__service__ShortDomainService_all + 7, current.operation);
    if(r.first == r.second)
    {
